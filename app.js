...
passport.use(new GoogleStrategy({
  ...
  callbackURL: "https://abdooo-lafs10fx2-abdelrhamans-projects.vercel.app/auth/google/callback", // Updated callback URL
  ...
  try {
    ...
    if (!user) {
      const hashedPassword = await bcrypt.hash("defaultpassword", 10); // Default password for new users
...
// Connect to MongoDB
mongoose.connect('mongodb+srv://abdelrhman:abdelrhman@cluster0.5vt9t.mongodb.net/<dbname>', {
  ...
  .catch(err => {
    ...
    app.listen(port, () => {
      console.log(`Server running at https://abdooo-lafs10fx2-abdelrhamans-projects.vercel.app/`);
    });
  })
...
//   clientID: process.env.GOOGLE_CLIENT_ID,  // Use your Google Client ID
//   clientSecret: process.env.GOOGLE_CLIENT_SECRET,  // Use your Google Client Secret
//   callbackURL: "https://abdooo-lafs10fx2-abdelrhamans-projects.vercel.app/auth/google/callback",  // Set correct callback URL
//   scope: ['profile', 'email'],  // Request the profile and email information
// }, async (accessToken, refreshToken, profile, done) => {
//   try {
//     let user = await User.findOne({ googleId: profile.id });
...
//   socketTimeoutMS: 10000    // 10 ثواني
// })
//   .then(() => {
//     console.log('Successfully connected to MongoDB!');
//   })
